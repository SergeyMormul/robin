...
public class Stencil implements IShape
{
	...
	protected void drawShadow(GraphicsCanvas2D canvas, CellState state, double rotation, boolean flipH,
                              boolean flipV, Rectangle bounds, double alpha, boolean filled, Rectangle aspect)
	{
	...
	public boolean drawShape(GraphicsCanvas2D canvas, CellState state,
                             Rectangle bounds, Rectangle aspect, boolean background)
	{
	 ...
	 * given rectangle.
	 */
	protected Rectangle computeAspect(CellState state, Rectangle bounds,
                                      String direction)
	{
