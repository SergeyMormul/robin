...
public class GraphOutline extends JComponent
{
	...
	public void repaintTripleBuffer(java.awt.Rectangle clip)
	{
		if (tripleBuffered && tripleBufferGraphics != null)
		{
			if (clip == null)
			{
				clip = new java.awt.Rectangle(tripleBuffer.getWidth(),
	...
	public void updateFinder(boolean repaint)
	{
		...
		updateFinderBounds(new java.awt.Rectangle(x + translate.x, y + translate.y,
				w + 1, h + 1), repaint);
	}
		...
		if (this.graphComponent != null)
		{
			...
			if (gw > 0 && gh > 0)
			{
				...
				double graphScale = graphComponent.getGraph().getView()
						.getScale();
				Point trans = graphComponent.getGraph().getView()
						.getTranslate();
	...
	public class MouseTracker implements MouseListener, MouseMotionListener
	{
		...
		public void mouseDragged(MouseEvent e)
		{
			if (isEnabled() && start != null)
			{
				if (zoomGesture)
				{
					java.awt.Rectangle bounds = graphComponent.getViewport()
							.getViewRect();
