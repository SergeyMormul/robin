...
import com.sciforce.robin.graph.swing.util.GraphTransferable;
import com.sciforce.robin.graph.swing.util.MouseAdapter;
import com.sciforce.robin.graph.util.CellRenderer;
					...
					if (th instanceof GraphTransferHandler)
					{
						...
						if (t != null)
						{
							e.startDrag(null, SwingConstants.EMPTY_IMAGE,
									new java.awt.Point(), t, new DragSourceAdapter()
									{
			...
			try
			{
				...
				if (t.isDataFlavorSupported(GraphTransferable.dataFlavor))
				{
					...
					if (gt.getBounds() != null)
					{
						...
						setPreviewBounds(new java.awt.Rectangle(
	...
	public void dragOver(DropTargetDragEvent e)
	{
		if (canImport)
		{
			...
			if (handler != null)
			{
				Graph graph = graphComponent.getGraph();
				double scale = graph.getView().getScale();
				java.awt.Point pt = SwingUtilities.convertPoint(graphComponent,
				...
				handler.setOffset(new java.awt.Point((int) graph.snap(dx / scale),
	...
	public void mouseDragged(MouseEvent e)
	{
		...
		if (graphComponent.isAutoScroll())
		{
			graphComponent.getGraphControl().scrollRectToVisible(
					new java.awt.Rectangle(e.getPoint()));
		}
		...
		if (!e.isConsumed())
		{
			...
			if (first != null)
			{
				...
				else if (cellBounds != null)
				{
					...
					if (previewBounds != null)
					{
						setPreviewBounds(new java.awt.Rectangle(getPreviewLocation(e,
