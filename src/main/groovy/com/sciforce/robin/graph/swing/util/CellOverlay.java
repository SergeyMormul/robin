...
public class CellOverlay extends JComponent implements ICellOverlay
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.sciforce.robin.mx.mxgraph.swing.util.mxIOverlay#getBounds(CellState)
	 */
	public Rectangle getBounds(CellState state)
	{
		...
		if (isEdge)
		{
			...
			else
			{
				...
				pt = new Point(p0.getX() + (p1.getX() - p0.getX()) / 2,
		...
		return new Rectangle(pt.getX() - w * defaultOverlap * s, pt.getY()
