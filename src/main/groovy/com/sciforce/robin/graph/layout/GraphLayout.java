...
public abstract class GraphLayout implements IGraphLayout
{
	...
	/* (non-Javadoc)
	 * @see IGraphLayout#move(java.lang.Object, double, double)
	 */
	...
	public Point getParentOffset(Object parent)
	{
	 ...
	 */
	public void setEdgePoints(Object edge, List<Point> points)
	{
		IGraphModel model = graph.getModel();
	 ...
	 */
	public Rectangle getVertexBounds(Object vertex)
	{
		...
		if (useBoundingBox)
		{
			...
			if (state != null)
			{
				...
				geo = new Rectangle(geo.getX() + dx0, geo.getY() + dy0,
	 ...
	 */
	public Rectangle setVertexLocation(Object vertex, double x, double y)
	{
		IGraphModel model = graph.getModel();
		...
		if (geometry != null)
		{
			result = new Rectangle(x, y, geometry.getWidth(),
					geometry.getHeight());
